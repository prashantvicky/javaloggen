...
public final class StdOut {
   ...
   /**
    ...
    public static void main(String[] args) {
        ...
        StdOut.println(strDate+" [sessmgr 11111 trace] [2/0/2222 <sessmgr:1> hsgw_funcs.c:222]     [software internal user syslog] HSGW Driver: Driver FSM state transition from              HSGWDRV_STATE_OPEN to HSGWDRV_STATE_NEWCALL_ARRIVED");
    	try {
			Thread.sleep(1000);
